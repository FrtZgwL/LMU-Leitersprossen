...
Besonders in der Philosophie drehen sich Debatten häufig darum, ob gewisse Formulierungen überhaupt sinnvolle Sprache oder ob sie nichts weiter als Geräusche, Tintenkleckse, leuchtende Pixel, Unsinn sind. Das ist relevant, weil Unsinnigkeit Grund genug ist, einen Versuch, sich philosophisch zu positionieren, zurückzuweisen. Mehr noch: Wenn wir einer Philosoph*in nachweisen können, dass sie Unsinn redet, ergibt sich daraus, dass sie nicht mal eine Position vertreten hat. Da ist keine These, die sie vertritt, nichts, das durch ihre Argumente gestützt wird. Ludwig Wittgenstein ergründet mit seinem \emph{Tractatus logico-philosophicus} (im Folgenden TLP) unter anderem, wann wir Unsinn reden und wann nicht. In diesem Essay werde ich diesen Versuch diskutieren und dabei feststellen, dass er als Unsinns-Kriterium scheitert. Dabei betrachte ich nur die Interpretation James Conants.
...
Das vierte Problem ist, dass Argumentation nur möglich ist, wenn Argumente eine innere logische Struktur haben. Das lässt sich bei deduktiven Argumenten besonders leicht erkennen. Solche Argumente sind in Diskussionen zulässig, weil ihre Konklusionen logisch aus ihren Prämissen folgen. Wittgenstein zufolge unterscheidet sich aber Unsinn von Sinnvollem und Sinnlosem gerade dadurch, dass er keine solche logische Struktur hat. Damit können mit unsinnigen Sätzen keine Argumente formuliert werden. Wir sollten philosophische Ansätze aber nur akzeptieren, wenn gute Gründe für sie sprechen.
...
So können wir auch die naive Rekonstruktion, die ich oben formuliert habe, nach Conant einordnen. Wittgenstein schreibt unsinnige Sätze wie \enquote{Der Sachverhalt ist eine Verbindung von Gegenständen (Sachen, Dingen).}\autocite[][2.01]{wittgenstein2016} Durch diese Sätze sollen wir erst annehmen, dass sie trotz ihrer Unsinnigkeit eine unaussprechliche Einsicht kommunizieren. Dass Sachverhalte also wirklich Verbindungen von Gegenständen sind, wir das aber nur denken und nicht sagen können, weil die Symbole \enquote{Sachverhalt} und \enquote{Gegenstand} so kombiniert werden, wie es die logische Syntax verbietet. Später sollen wir dann merken, dass es gar keine unaussprechliche Einsicht zu kommunizieren gab, sondern Wittgensteins Sätze von Anfang an \emph{einfach-nur-Unsinn} waren.

% TODO Logische Kategorien übergreifende Äquivokation

Conant begründet diese Position, indem er dafür argumentiert, dass schon Frege das unaussprechbarkeits-Verständnis von Unsinn vertreten hat. Wittgenstein setze sich mit den Spannungen auseinander, die dabei aus Freges Philosophie resultieren und löse diese zu einem resoluten Verständnis von Unsinn auf. Die relevante Spannung besteht zwischen der Einsicht, dass sich die Begriffsschrift nicht mit den Mitteln der Begriffsschrift schildern lässt auf der einen, und dem Kontextprinzip auf der andereren Seite.
...
Wittgenstein schreibt an zahlreichen Stellen \textbf{...JA WAS SCHREIBT ER DENN AN ZAHLREICHEN STELLEN, CEDRIC? ^^}} Conant schließt daraus, dass Wittgenstein keine Grenze zwischen aussprechbaren und unaussprechlichen Gedanken zieht. Er entwickelt auch kein Unsinnskriterium, das zwischen sinnvollen und unsinnigen Sätzen unterscheidet. Jeder Gedanke kann ausgedrückt werden und jeder mögliche Satz ist sinnvoll. Die unsinnige Zeichenkette \enquote{Sokrates ist identisch.} ist demnach kein Satz. Oder zumindest nicht, solange wir ihr keine Interpretation verleihen, die für alle ihre Bestandteile plausibel ist.

\section{Was bleibt, wenn die Leiter fällt?}

Das klingt auf den ersten Blick radikal, lässt aber Fragen offen. Denn Wittgenstein kündigt im Vorwort an, dass er die philosophischen Probleme im Wesentlichen und endgültig lösen wird. Mit \enquote{Sachverhalt}, \enquote{Gegenstand}, \enquote{Name}, \enquote{Zeichen}, etc. entwickelt er ein eigenwilliges Vokabular. Mithilfe dessen geht er dann auf klassische Probleme aus allen wesentlichen philosophischen Disziplinen ein. Wie ist das Conant zufolge zu verstehen?

Eine Deutungsmöglichkeit ist, dass uns Wittgenstein hier noch immer in die substanzielle Konzeption einlullt. Wir sollen den Eindruck gewinnen, im Besitz unaussprechlicher Erkenntnisse über Gegenstände, Sachverhalte, etc. zu sein, aus denen sich Lösungen der philosophischen Probleme ergeben. Doch sobald wir die Leiter wegwerfen, sind wir diese Illusion los. Wittgenstein löst also nicht mehr die ganze Philosophie, sondern nur noch die substanzielle Lesart auf. Das könnte ähnlich wie eine Reductio ad Absurdum funktionieren. Wittgenstein formuliert Argumente innerhalb der substanziellen Konzeption, aus denen später folgt, dass diese unsinnig ist. Neben dem faden Beigeschmack, den Wittgensteins in anderen Interpretationen aufregende und ambitionierte Werk jetzt hat, widerspricht diese Interpretation aber dem Vorwort, weil kaum philosophische Probleme gelöst werden. Es ist, als würde die Leiter flach auf dem Boden liegen und wir sie entlangkrabbeln. Außerdem ist mit dieser Interpretation nicht sicher gestellt, dass Wittgensteins Sätze unsinnig sind. Schließlich könnte auch aus falschen Sätzen folgen, dass diese unsinnig sind.

Nach einer zweiten Deutungsmöglichkeit ist Conants Bemerkung, dass es nach Wittgenstein kein Unsinnskriterium und keine Grenze unserer Sprache gibt, folgendermaßen zu verstehen. Um einen sinnvollen Satz zu äußern, müssen wir impliziten und unexplizierbaren Regeln logischer Syntax folgen. Denn diese Regeln sind konstitutiv für Sinn. Es gibt also kein Unsinnskriterium in der Hinsicht, dass wir keinen sinnvollen Satz formulieren können, der zwischen Sinn und Unsinn unterscheidet. Und es gibt keine Grenze von Sprache in der Hinsicht, dass es erlaubte und unerlaubte Sinne und Bedeutungen gibt, die wir Sätzen verleihen können. Gleichzeitig gibt es Unsinnskriterium und Grenzen der Sprache in Form von Regeln logischer Syntax, die wir verstehen, indem wir verstehen, warum Sätze unsinnig sind. % Philosophie gelöst

% Dass jeder Satz sinnvoll ist und es keine Grenze der Sprache gibt ist dann so zu verstehen, wie dass es keine Grenze des Schachs gibt.\footnote{Keine einzige Regeln von Schach ist konstitutiv für das Spiel. Man könnte ohne Rochade oder ohne en passent spielen, die Bewegung einzelner Figuren leicht einschränken oder erweitern, die Figuren anders aufstellen oder verändern was, passiert, wenn sich Figuren schlagen und dennoch Schach spielen. Erst, wenn zu viel davon auf einmal tut, spielt man kein Schach mehr.}

Jetzt steht die Leiter wieder aufrecht. Doch sie wird heimlich von einer substanziellen Lesart gestützt, die sich nur als resolut verkleidet.



In Wittgensteins Sprachbild befinden wir uns, nachdem wir die Leiter eklommen haben, an einer erhöhten Position. Wir überblicken mehr als zuvor. Einige von Conants Forderungen die ganze Leiter wegzuwerfen wirken aber so radikal, dass schwer zu sehen ist, wie wir danach höher stehen. Es wirkt, als hätte Conants Wittgenstein die Leiter flach auf den Boden gelegt und wir würden sie entlangkrabbeln.




\section{Entwickelt Wittgenstein nach Conant ein Unsinnskriterium?}

Das stellt in Frage, ob sich Conants Wittgenstein überhaupt mit dem Thema auseinandersetzt, das ich hier erforsche. Wittgenstein jetzt vorzuwerfen, dass sein Ansatz als Unsinnskriterium scheitert, klingt, als würde ich einem Basketballspieler vorwerfen, dass er gegen die Regeln von Fußball verstößt.

Doch ganz so bodenlos ist meine Kritik nicht. Denn obwohl Conant daran festhält, dass Wittgenstein kein Unsinnskriterium entwickelt, muss er vertreten, dass Wittgenstein ergründet, wie wir Unsinn als solchen erkennen können. Schließlich soll der TLP trotz allem die philosophischen Probleme im Wesentlichen und endgültig lösen.\autocite[Vgl.][Vorwort]{wittgenstein2016} Es ist nicht eindeutig, wie weit der Philosophiebegriff ist, den Conant Wittgenstein unterstellt. Zuweilen schreibt Conant, als sei Philosophie nach Wittgenstein ein eng eingerenztes Projekt, dass sich ausschließlich bestimmten technischen Fragen um Logik und Sprache widmet. Teilweise schreibt er, dass der gesamte TLP nur gegen die substanzielle Konzeption von Unsinn und Erläuterung argumentieren soll. Andererseits geht Wittgenstein auf die gesamte Bandbreite der Philosophie ein. Von seinen Überlegungen zu Sprache, Logik und Metaphysik kommt er zu Erkenntnistheorie, Ethik, Ästhetik, Religion, Leben und Tod. Er stellt sich auch klassischen Problemen wie der Frage nach dem Wesen von Kausalität, Wahrheit, Wahrscheinlichkeit, Zahlen, Wissenschaft oder personaler Identität, dem Induktionsproblem, dem Skeptizismus oder dem Solipzismus. Es wäre daher wohlwollender, Wittgenstein schon in der Einleitung einen weiten Blick auf die Philosophie und damit auch einen weiten Philosophiebegriff zuzumuten. Insbesondere beim weiten Philosophiebegriff besteht Wittgensteins Lösung der Probleme häufig darin, dass er aufzeigt, inwiefern die Fragestellungen unsinnig sind. Selbst, wenn er kein Unsinns-Kriterium entwickelt, muss er uns also lehren, zwischen Sinn und Unsinn zu unterscheiden.

Außerdem lehnt Conant die Idee, dass es Regeln logischer Syntax gibt, die festlegen, welche sinnvollen Sätze möglich sind, nicht vollständig ab. Er widerspricht allen expliziten Regeln. Gleichzeitig akzeptiert er implizite konstitutive Regeln sinnvoller Sprache, die einschränken, was überhaupt als Interpretation gilt. Denn er würde zum Beispiel nie eine Interpretation eines Satzes zulassen, nach der ein Satz und eine Wahrheitsfunktion Argumente einer Wahrheitsfunktion sind. Wir müssen eine Zeichenkette wie $p \vee \subset$ entweder anders interpretieren, oder sie ist einfach-nur-Unsinn. So lässt sich Wittgenstein als weiter oder enger Philosophiekritiker verstehen. % TODO: Das nochmal weiter ausführen.

\section{Sind alle Leitersprossen befestigt?}

Prüfen wir zum Schluss, ob es Conant gelingt, alle losen Leitersprossen zu befestigen. Zum ersten Problem gibt er dieselbe Antwort wie auch substanzielle Leser*innen. Wittgenstein produziert einleuchtenden Unsinn, der im Gegensatz zu irreführendem Unsinn auf eine Art und Weise lehrreich ist, auf die das sinnvolle Sprache nie sein kann. Er führt diese Antwort aber anders aus. Ihmzufolge lullt uns der Unsinn ein. Wir halten ihn für sinnvolle Argumente und Thesen. Sobald wir diese konsequent zuende denken, merken wir aber, dass es einfach nur Unsinn war. An diesem Beispiel werden wir uns der von Bedingungen sinnvoller Sprache überhaupt bewusst und lernen daher etwas.

Das Problem der Grenzen des Zeigbaren setzt voraus...

Auch auf das Problem der Kommunikation des TLP würde Conant antworten, indem er die spezielle Form der Täuschungs-Dialektik schildert, die Wittgenstein ihm zufolge betreibt. Wittgenstein zerschmettere Illusionen, indem er uns zuerst zu ihnen verführe und sie dann zerstöre. Denn indem er sie konsequent ausformuliert, sollen wir merken, dass sie einfach-nur-Unsinn sind.

Doch Conants Interpretation kämpft mit dem Problem der argumentativen Struktur des TLP. Denn Wittgenstein mag denken, dass er uns zuerst zu einer substanziellen Auffassung von Unsinn täuscht und uns dann dazu bringt, die Welt richtig zu sehen. Doch es ist noch offen ob wir gute Gründe haben, diese Gedanken zu akzeptieren. In Sekten werden neuen Mitgliedern die eigenen Glaubenssätze häufig nur häppchenweise verkauft. Bei einem frühen Scientology-Treffen erfährt man vielleicht schon, dass die eigenen praktischen Lebensprobleme durch kleine böse Geister verursacht werden. Man lernt aber noch nicht, dass der Sektenanführer persönlich gegen außerirdische Aliens gekämpft hat. Ältere Sektenmitglieder täuschen neuere Sektenmitglieder also bewusst (Es geht nur um Geister), um diese Täuschung später aufzulösen und ihnen zu helfen, die Welt richtig zu sehen (Eigentlich geht es um Aliens). An diesem Beispiel wird aber deutlich, dass derartige Täuschungs-Dialektik nicht ohne eine argumentative Stützung der Art und Weise, die Welt richtig zu sehen, auskommt.\autocite[Für eine Diskussion verschiedener Sekten und ihrer Struktur verschiedener \enquote{Ebenen der Wahrheit} vgl.][]{hassan2015} Wenn das bei Sekten so ist, gilt es aber auch für Wittgenstein. Damit wir akzeptieren können, dass die Art und Weise, auf die wir nach Wittgenstein die Welt nach der Auflösung seiner Täuschung sehen sollen, auch die richtige Art ist, die Welt zu sehen, muss er Argumente vorbringen. Ich will hier nicht bestreiten, dass es solche Argumente gibt. Das Problem ist aber, dass solche Argumente, damit wir sie als \emph{Argumente} akzeptieren können, aus Prämissen und Konklusionen bestehen müssen, die in einem logisch gültigen Schluss (oder in einem formal korrekten induktiven Argument) zusammenhängen. So etwas darf Wittgenstein aber nach der Interpretation, die uns Conant schildert, höchstens verwenden, um uns zu täuschen, denn die Welt richtig zu sehen, lernen wir nach dieser Interpretation nur durch \enquote{einfach-nur-Unsinn}.

\section{Diskussionsanregungen}

- Könnte ein Unsinnskriterium gelingen? Wie sollen wir sonst zwischen Sinn und Unsinn unterscheiden, wenn überhaupt?
- Ist Wittgenstein auf dem richtigen Weg, oder müssen wir es ganz anders angehen?
- Ist ein weiter oder enger Philosophiebegriff plausibler für die Interpretation Conants? Wittgensteins?
